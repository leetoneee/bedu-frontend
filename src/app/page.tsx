...
export default function Home() {
  return (
    <main className="">
        ...
        <div className="mx-16 mt-16 grid grid-cols-5 2xl:mx-20 2xl:mt-20">
          <div className="col-span-3 mr-8 flex flex-col 2xl:mr-10">
            <span className="mb-4 text-3xl font-semibold 2xl:text-4xl">
              This is Your Gateway to Unlimited Educational Resources
            </span>
            <div className="mb-7 flex flex-col 2xl:mb-8">
              <span className="text-base">
                Discover a world of learning at your fingertips with our
                comprehensive educational
              </span>
              <span className="text-base">
                platform. You're a student, educator, or lifelong learner, our
                site offers
              </span>
              <span className="text-base">
            ...
            <div className="flex flex-row gap-8">
              ...
              <div className="relative flex h-28 w-40 items-center justify-center rounded-md border border-outline bg-white shadow-lg 2xl:w-44">
                <div className="absolute flex flex-col items-center gap-1">
                  ...
                  <p className="font-semibold text-outline-focus">140K</p>
                  <p className="text-sm text-outline-focus">Active Students</p>
                </div>
              </div>
              ...
              <div className="relative flex h-28 w-40 items-center justify-center rounded-md border border-outline bg-white shadow-lg 2xl:w-44">
                <div className="absolute flex flex-col items-center gap-1">
                  ...
                  <p className="font-semibold text-outline-focus">18</p>
                  <p className="text-sm text-outline-focus">Courses</p>
                </div>
              </div>
              ...
              <div className="relative flex h-28 w-40 items-center justify-center rounded-md border border-outline bg-white shadow-lg 2xl:w-44">
                <div className="absolute flex flex-col items-center gap-1">
                  ...
                  <p className="font-semibold text-outline-focus">45K</p>
                  <p className="text-sm text-outline-focus">Teachers</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-7 flex space-x-4 2xl:mt-8">
              <FaFacebookSquare size={40} className="text-outline-focus" />
              <FaLinkedin size={40} className="text-outline-focus" />
              <FaInstagramSquare size={40} className="text-outline-focus" />
          ...
          <div className="col-span-2 col-end-6 grid grid-cols-2 gap-5">
            <div className="col-span-1 grid grid-rows-2 justify-end gap-5">
              <Image src={girl_1} alt="girl 1" className="row-span-1" />
      ...
      <div className="flex h-screen flex-col bg-surface">
        <div className="grid grid-cols-7 gap-20">
          <div className="col-span-3 mt-20 h-5 2xl:mt-60">
            <Image src={About_bdu_pic} alt="About BEDU picture" className="" />
          </div>
          <div className="col-span-4 col-end-8">
            <div className="mr-28 mt-[106px] 2xl:mt-72">
              ...
              <p className="mt-6">
                Discover a world of learning at your fingertips with our
                comprehensive educational platform.you're a student, educator,
                or lifelong learner, our site offers an extensive collection of
                resources
              </p>
              <p className="mt-7">
                Discover a world of learning at your fingertips with our
      ...
      {/* Phân trang 3 */}
      <div className="flex h-screen flex-col bg-b-primary">
        <p className="mx-auto mt-16 text-5xl font-bold text-on-primary">
          Featured categories
        </p>
        <div className="mt-10 grid grid-cols-7">
          ...
          <div className="relative col-start-2 flex h-56 w-52 items-center justify-center rounded-md border border-outline bg-categories shadow-lg">
            <div className="absolute flex flex-col items-center gap-1">
              ...
              <p className="mt-4 font-medium text-on-surface">Live Program</p>
              <div className="mt-3 flex flex-row gap-1">
                <p className="text-sm text-outline-focus">7 programs</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
          ...
          <div className="relative col-start-6 flex h-56 w-52 items-center justify-center rounded-md border border-outline bg-categories shadow-lg">
            <div className="absolute flex flex-col items-center gap-1">
              ...
              <p className="mt-4 font-medium text-on-surface">Feedback</p>
              <div className="mt-3 flex flex-row gap-1">
                <p className="text-sm text-outline-focus">7 feedbacks</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
        ...
        <div className="mt-10 grid grid-cols-7">
          ...
          <div className="relative col-start-3 flex h-56 w-52 items-center justify-center rounded-md border border-outline bg-categories shadow-lg">
            <div className="absolute flex flex-col items-center gap-1">
              <Image src={youtube} alt="Youtube Channel" className="" />
              <p className="mt-4 font-medium text-on-surface">
                Youtube channel
              </p>
              <div className="mt-3 flex flex-row gap-1">
                <p className="text-sm text-outline-focus">7 subscribers</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
          ...
          <div className="relative col-start-5 flex h-56 w-52 items-center justify-center rounded-md border border-outline bg-categories shadow-lg">
            <div className="absolute flex flex-col items-center gap-1">
              ...
              <p className="mt-4 font-medium text-on-surface">Facebook</p>
              <div className="mt-3 flex flex-row gap-1">
                <p className="text-sm text-outline-focus">99+ follows</p>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
