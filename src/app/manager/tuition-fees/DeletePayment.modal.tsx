          ...
          <>
            ...
            <ModalBody>
              <div className="space-y-2">
                <div className="text-lg font-semibold">Remove tuition fee</div>
                <div className="text-sm font-normal">
                  Are you sure you want to remove this tuition fee with the
                  transaction ID <strong>{transactionId}</strong>? This
                  information will be permanently deleted and cannot be undone.
                </div>
              </div>
            </ModalBody>
